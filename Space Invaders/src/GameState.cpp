...
void GameState::Update(float dt)
{
	...
	if (isFiring)
	{
		...
		newBullet.setPos(player->getSprite().getPosition().x - 25, player->getSprite().getPosition().y - 60);
